...
dates_monday = pd.date_range("20180604", periods=18, freq="7D") # forecasts start Monday
dates_thursday = pd.date_range("20180607", periods=18, freq="7D") # forecasts start Thursday
