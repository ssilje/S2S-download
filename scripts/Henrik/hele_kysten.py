...
while smaller_than(t_end,(2021,4,1)):
    ...
    observations = Observations(
                                name='hele_NorKyst-800_'+str(month)+year,
                                observations=nk,
                                forecast=hindcast,
                                process=False
                                )
    ...
    for step in steps:
        ...
        for ref_fc,lab in zip([mae_clim,mae_pers],['CLIM','PERS']):
            ...
            graphics.save_fig(fig,
                            year+'hele_mae_skill_map_NorKyst_month'+month+lab+str(step.days)
                            )
        ...
        graphics.save_fig(fig,
                        year+'hele_crps_skill_map_NorKyst_month'+month+'CLIM'+str(step.days)
                        )
