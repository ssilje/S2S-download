...
from S2S.data_handler        import BarentsWatch, ERA5, ECMWF_S2SH, Archive, IMR
...
if process_hindcast:
    ...
    hindcast = xh.running_mean(hindcast[var],window=7)
...
if process_observations:
    ...
    observations = xh.running_mean_o(observations[var],window=7)
    ...
    clim_mean,clim_std = xh.o_climatology(observations,'time.month')
